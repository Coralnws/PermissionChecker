// src/lib.rs
/*
 * Core library for PermissionChecker
 */
...
#[derive(Debug)]
pub struct PermissionCheckerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PermissionCheckerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PermissionChecker processing");
    
    let mut processor = PermissionCheckerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PermissionCheckerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PermissionCheckerProcessor::new(false);
